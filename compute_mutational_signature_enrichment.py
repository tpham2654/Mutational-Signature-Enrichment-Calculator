...
from _load_cosmic_mutation_signature_by_number import _load_cosmic_mutation_signature_by_number
...
def compute_mutational_signature_enrichment(
    ...
    cosmic_mutation_signature_number = 0,  #0 = PMACD mutations
    ...
    if (use_reverse_complements==True) and (cosmic_mutation_signature_number == 0):
        signature_component_weight_reverse_complement = {
        "TGA ==> TCA": 1,
        "TGA ==> TAA": 1,
        "AGA ==> ACA": 1,
        "AGA ==> AAA": 1,}
        signature_component_weight = {**signature_component_weight, **signature_component_weight_reverse_complement}
    if cosmic_mutation_signature_number > 0:
        signature_component_weight = _load_cosmic_mutation_signature_by_number(cosmic_mutation_signature_number,use_reverse_complements)
